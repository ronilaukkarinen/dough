...
\u2022 "Milloin olemme velattomia?"`,
  ...
  investments: {
    title: "Sijoitukset",
    subtitle: "Seuraa kuukausisijoituksia ja tuotto-odotuksia",
    addInvestment: "Lisää sijoitus",
    addInvestmentTitle: "Lisää sijoitus",
    name: "Nimi",
    namePlaceholder: "esim. S&P 500 ETF",
    monthlyAmount: "Kuukausierä (€)",
    expectedDay: "Sijoituspäivä",
    expectedReturn: "Tuotto-odotus (%)",
    currentValue: "Nykyarvo (€)",
    totalMonthly: "Kuukausierät yhteensä",
    totalValue: "Salkun arvo",
    projectedGrowth: "Tuottoennuste",
    projectedValue: "Ennustettu arvo",
    afterYears: "jälkeen",
    years: "vuotta",
    invested: "Sijoitettu",
    returns: "Tuotto",
    transfersTo: "Siirto tilille",
  },
  settings: {
    title: "Asetukset",
