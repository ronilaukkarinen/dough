export const fi = {
  ...
  dashboard: {
    ...
    cutNonEssentials: "Vain välttämättömät menot jatkossa",
...
\u2022 "Milloin olemme velattomia?"`,
  ...
  investments: {
    title: "Sijoitukset",
    subtitle: "Seuraa sijoitustilejä ja tuotto-odotuksia",
    totalMonthly: "Kuukausisijoitukset",
