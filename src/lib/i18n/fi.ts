export const fi = {
  ...
  dashboard: {
    ...
    billsDue: "Laskuja erääntymässä",
    nextIncome: "Seuraava tulo",
    cashFlowForecast: "Kassavirtaennuste",
    endOfMonthEstimate: "Kuun lopun arvio",
    daysUntilNextIncome: "päivää seuraavaan tuloon",
    cutNonEssentials: "karsi turhia kuluja",
    beCareful: "ole varovainen",
...
\u2022 "Milloin olemme velattomia?"`,
  ...
  income: {
    ...
    guaranteedRecurring: "Taattu toistuva",
